...
class No {
 ...
 class ArvoreBinaria {
	 ...
	 * <code>false</code> em caso contrario.
	 */
	public boolean pesquisar(Game x, No i) {
      boolean resp;
		if (i == null) {
         resp = false;

      } else if (x.getAppId() == i.game.getAppId()) {
         resp = true;
	...
	private void caminharCentral(No i) {
		if (i != null) {
			...
			System.out.println(i.game.getName() + " "); // Conteudo do no.
	...
	private void caminharPre(No i) {
		if (i != null) {
			System.out.print(i.game.getAppId() + " "); // Conteudo do no.
