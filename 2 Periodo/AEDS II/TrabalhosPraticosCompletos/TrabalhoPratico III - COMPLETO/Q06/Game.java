        ...
        public static void main(String[] args)  throws Exception {//Inicio main
           //--variaveis--//
            ...
            for(int i = 0 ; i<lista.getTamanho(); i++){
                    frases[i]=Game.juntarAtributos(lista.getElemento(i), path);//cria array de string com todas as frases do arquivo csv que possuem mesmo id escrito no pubin
