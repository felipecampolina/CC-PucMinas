...
public class Game {
    ...
    public void fazTudo(String comando, String id, Pilha pilha,String path) throws Exception{
        ...
        switch(comando){
            ...
            case "R":
               ...
               imprimeRemovidos(pilha.remover(), path);
            break;
        }
    }

    public void fazTudoException(String comando, String pos, String id, Pilha pilha,String path) throws Exception{
        int idInt = Integer.parseInt(id);
    ...
    public static void main(String[] args)  throws Exception {
        ...
        for(int i = 0; i<numeroLinhas; i++){
            ...
            try{
                ...
                Game.fazTudo(stringSeparada[0], stringSeparada[1], pilha,path);
            }catch(java.lang.ArrayIndexOutOfBoundsException e){
                Game.fazTudo(stringSeparada[0], "0", pilha,path);
            }
            
        }

        listaCheia = pilha.mostrar();
        String fraseInteira;
