 ...
 class ArvoreBinaria {
   ...
   public int getAltura(No i, int altura){
	...
	private No rotacionarEsq(No no){
		No noDir = no.dir ; // cria um novo novo e atribue ele como o no.dir
		No noDirEsq = noDir.esq; // cria um novo no e atribue ele como o esq do no criado anteriormente

		noDir.esq = no; // atribue a esqurda do no criado como o no.dir do parametro
		no.dir = noDirEsq; // atribue o no.dir do parametro como o noDirEsq criado na segunda linha
		return noDir;
	}

	public No rotacionarDir(No no){
		No noEsq = no.esq; // cria um novo no e atribue ele como o esq do parametro
		No NoEsqDir = noEsq.dir;// cria um novo no e atribue ele como o dir do no criado anterioemente
		
		noEsq.dir = no; // atribue o ponteiro direito do primeiro no crioado como o parametro 
		no.esq  = NoEsqDir; // atribue o ponteiro do parametro como o segundo no criado
