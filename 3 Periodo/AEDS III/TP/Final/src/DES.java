...
public class DES {
	...
	public static void mostraAlgoritimo(String texto) throws IOException {
		...
		try {
			...
			RandomAccessFile arq1 = new RandomAccessFile("dados/dadosCriptografadoDES.db", "rw");
			...
			RandomAccessFile arq2 = new RandomAccessFile("dados/dadosDescriptografadoDES.db", "rw");
