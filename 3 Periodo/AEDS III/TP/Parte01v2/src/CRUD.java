...
public class CRUD {
    ...
    public static int resetarBancoDeDados(BufferedReader leitura)
        ...
        while (opcao != 7) {
            ...
            switch (opcao) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    ultimoID = resetarBancoDeDados(leitura);// RESET
                    break;
                case 6:
                    System.out.println("--------------");
                    ...
                    switch (opcao) {
                        ...
                        case 2:
                            ...
                            System.out.println("-- De um valor para N,ou seja , a quantidade de arquivos temp: ");
                            int n = sc.nextInt();
                        ...
                        case 3:
                            ...
                            System.out.println("-- De um valor para N,ou seja , a quantidade de blocos: ");
                            int x = sc.nextInt();
