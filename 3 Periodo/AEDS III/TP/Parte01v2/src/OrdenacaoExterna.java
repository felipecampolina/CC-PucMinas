...
public class OrdenacaoExterna extends CRUD {
      ...
      for (i = 0; i < N; i++) {
        ...
        if (arrayDif[minFile] == 0) {
          for (int k = 0; k < slices; k++) {
            ...
            if (arrayDif[minFile] > 0) { // se a diferença for maior que zero, precisamos pular bytes para chegar no
              // próximo registro válido
              brs[minFile].seek(brs[minFile].getFilePointer() + arrayDif[minFile]);
              posIni += arrayDif[minFile];
              arrayDif[minFile] = 0; // zera a diferença, pois já foi pulado o necessário
            }
  ...
  public static Filme[] IntercalacaoBalanceadaVariavel(int bloco, int n, Filme[] filme) throws Exception {
    ...
    Filme[] temp1 = lerTemp("arquivosTemporarios/arq1.tmp");
    Filme[] temp2 = lerTemp("arquivosTemporarios/arq2.tmp");
    ...
    while (temp1[ponteiro1] != null || temp2[ponteiro2] != null) {
      while (controle1 == false || controle2 == false) {
        ...
        if (temp1[ponteiro1] == null && temp2[ponteiro2] == null) {
          ...
          if (temp1[ponteiro1].titulo.compareTo(temp1[ponteiro1 + 1].titulo) > 0) {
        ...
        if (temp2[ponteiro2] == null) {
          ...
          if (temp2[ponteiro2].titulo.compareTo(temp2[ponteiro2 + 1].titulo) > 0) {
      ...
      while (temp3[ponteiro1] != null || temp4[ponteiro2] != null) {
        while (controle1 == false || controle2 == false) {
          ...
          if (temp3[ponteiro1] == null && temp4[ponteiro2] == null) {
            ...
            if (temp3[ponteiro1].titulo.compareTo(temp3[ponteiro1 + 1].titulo) > 0) {
          ...
          if (temp4[ponteiro2] == null) {
            ...
            if (temp4[ponteiro2].titulo.compareTo(temp4[ponteiro2 + 1].titulo) > 0) {
