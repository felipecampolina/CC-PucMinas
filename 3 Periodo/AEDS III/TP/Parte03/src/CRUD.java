                ...
                case 6:
                    ...
                    switch (opcao) {
                        ...
                        case 3:
                            ...
                            LZW lzw = new LZW();
                            long start = System.currentTimeMillis();
                            lzw.compress("dados/filmes.db", "dados/filmesLZWCompressao" + numeroEscolhido + ".db",numeroEscolhido);
                            System.out.println("Arquivo filmesLZWCompressao" + numeroEscolhido + ".db"
                            + " criado com sucesso");
                            long end = System.currentTimeMillis() - start;
                            RandomAccessFile source = new RandomAccessFile("dados/filmes.db", "rw");
                            RandomAccessFile dest = new RandomAccessFile("dados/filmesLZWCompressao"+numeroEscolhido+".db", "rw");
                            float porcentagem = 100 - (((float) dest.length() / (float) source.length()) * 100);
                            System.out.println("Porcentagem reduzida(%): " + porcentagem);
                        ...
                        case 4:
                            ...
                            lzw2.decompress("dados/filmesLZWCompressao" + numeroEscolhido + ".db", "dados/filmes.db",numeroEscolhido);
